...
public class ApiClient {
    ...
    private String basePath = "https://8f59b9.natappfree.cc";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://8f59b9.natappfree.cc/api
...
//        //String json1 = new Gson().toJson(body);
